...
export const metadata: Metadata = {
  ...
  description: 'Experienced Full-Stack Developer specializing in React, Next.js, Node.js, and modern web technologies. View my interactive portfolio featuring innovative full-stack projects with cutting-edge UI/UX design.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Experienced Full-Stack Developer specializing in React, Next.js, Node.js, and modern web technologies. View my interactive portfolio featuring innovative projects.',
