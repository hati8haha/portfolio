		...
		<section id="about" className="mt-9 grid lg:grid-cols-[1fr_360px] gap-5">
			<div className="liquid-glass p-6">
				...
				<p className="text-[var(--muted)] mb-4">
					...
					creating engaging web applications. I love exploring new technologies
					and pushing the boundaries of what&apos;s possible in the browser.
				</p>
				<p className="text-[var(--muted)] mb-4">
					Currently focused on building performant React applications with
					modern UI/UX principles, accessibility standards, and cutting-edge web
					technologies.
				</p>
				<div id="contact" className="flex gap-3 mt-6">
					<a
						href="mailto:contact@example.com"
						className="chip hover:bg-white/5 transition-colors no-underline"
					>
						Email Me
					</a>
					<a
