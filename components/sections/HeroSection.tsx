...
const HeroSection = () => {
  return (
    <section className="mb-16" aria-label="Hero: Interactive Three.js Background Demo">
      <div className="text-center py-20">
        ...
        <p className="text-[var(--muted)] text-lg md:text-xl max-w-3xl mx-auto mb-8 leading-relaxed">
          ...
          that solve real-world problems. Specializing in modern JavaScript frameworks, 
          backend systems, and delivering exceptional user experiences.
        </p>
